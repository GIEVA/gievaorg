    ...
    <div>
      <div style={{ padding: "30px" }}>
        ...
        <p>
          ...
          guidance, financial aid, assessment, and enrollments. The most widely
          known programs of the College Board are SAT, and the PSAT/NMSQT.
        </p>
        ...
        >
          <table>
            <tr>
              ...
              <th style={{ width: "200px", textAlign: "initial" }}>LOCATION</th>
            </tr>
            <tr>
        ...
        <ul>
          <li>
            SAT The digital SAT consists of evidence-based reading and writing,
            and Mathematics.
          </li>
          <li>
            Candidates, willing to transfer their college/ university-earned
            credits from their home-country could also write the SAT, to be able
            to transfer such credits.
          </li>
          <li>
        ...
        <ul>
          <li>
            ACT ACT is written by candidates who desire to pursue their
